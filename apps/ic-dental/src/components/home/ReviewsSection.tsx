  ...
  return (
    <section className="py-24 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <h1 className="text-primary text-4xl font-bold tracking-wider uppercase">Patients Google Reviews</h1>
          <h2 className="text-3xl md:text-2xl font-display font-bold text-foreground mt-3 mb-4">
